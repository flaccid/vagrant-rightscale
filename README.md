...
# Vagrant RightScale Provider

<span class="badges">
</span>

This is a [Vagrant](http://www.vagrantup.com) 1.2+ plugin that adds a [RightScale](http://rightscale.com/)
provider to Vagrant, allowing Vagrant to control and provision machines in a variety of public and private clouds.
...
...
$ vagrant up --provider=rightscale
...
```

Of course prior to doing this, you'll need to obtain an RightScale-compatible
box file for Vagrant.

## Quick Start

After installing the plugin (instructions above), the quickest way to get
started is to actually use a dummy RightScale box and specify all the details
